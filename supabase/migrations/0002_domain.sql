-- 0002_domain.sql — budget categories and spending actuals
...
create index budget_categories_household_idx
  on public.budget_categories (household_id, sort_order, created_at);
...
create index category_actuals_category_idx
  on public.category_actuals (category_id);
